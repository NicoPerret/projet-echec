...
public class NotationCoup {
	...
	public int getCoordDepart64() {return coordDepart64;}

	public void setCoordDepart64(int coordDepart64) {this.coordDepart64 = coordDepart64;}

	public int getCoordArrivee64() {return coordArrivee64;}

	public void setCoordArrivee64(int coordArrivee64) {this.coordArrivee64 = coordArrivee64;}

	public String getCoordDepartStandard() {return coordDepartStandard;}

	public void setCoordDepartStandard(String coordDepartStandard) {this.coordDepartStandard = coordDepartStandard;}

	public String getCoordArriveeStandard() {return coordArriveeStandard;}

	public void setCoordArriveeStandard(String coordArriveeStandard) {this.coordArriveeStandard = coordArriveeStandard;}
