...
for (let typePiece of ["p", "t", "c", "f", "d", "r"]) {
  ...
  if (couleurJoueur == "blanc") {
    document
      .querySelector("div[nom=piecesCaptureesHaut]")
      .append(typePieceDivBlanc);
    document
      .querySelector("div[nom=piecesCaptureesBas]")
      .append(typePieceDivNoir);
  } else {
    document
      .querySelector("div[nom=piecesCaptureesHaut")
      .append(typePieceDivNoir);
...
for (let piece of piecesCapturees) {
  ...
  img.setAttribute(
    "src",
    "assets/SpritePiecesPNG/" + typePieceImg + couleurPieceImg + ".png"
  );
